    ...
    if tab not in visited:
        ...
        try:
            expected_out_video_score = (
                ...
                - resource.balance[course_title][0]
            )
            expected_in_video_score = (
                ...
                - resource.balance[course_title][1]
            )
        except:
            ...
            if i[1] == name:
                ...
                if expected_out_video_score > out_video_score:
                    ...
                    print(
                        ...
                        expected_out_video_score - int(i[3]),
                    )
                    title_printed = True
                ...
                if expected_in_video_score > in_video_score:
                    if title_printed == False:
                        ...
                        title_printed = True
                    print(
                        "Remaining in video score:", expected_in_video_score - int(i[5])
                    )
...
if imbalanced:
    print(
        "If possible, update the resource.py file in the assets folder with your course!"
    )
if title_printed == False:
